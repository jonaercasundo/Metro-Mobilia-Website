...
<head>
    ...
    <title>
        Product Catalog — Metro Mobilia Corporation
    </title>

    <meta
        name="description"
        content="Browse the full Metro Mobilia Corporation product catalog — school furniture, IT equipment, science kits, textbooks, and more."
    >
            ...
            <div class="mx-auto max-w-7xl">
                ...
                <div class="max-w-3xl">
                    ...
                    <h1 class="font-serif text-4xl font-light leading-[1.1] md:text-5xl lg:text-6xl">
                        Product
                        <br>
                        <em class="text-[#c8b89a]">Catalog.</em>
                    </h1>

                    <p class="mt-7 max-w-2xl text-sm font-light leading-[1.9] text-white/40">
                        Browse our full range of products available for schools,
                ...
                <div class="mt-10 flex flex-wrap gap-3">
                    ...
                    <a
                        ...
                        class="border px-4 py-2 text-[9px] uppercase tracking-[0.18em] transition
                            {{ !$activeCategory ? 'border-[#c8b89a] bg-[#c8b89a] text-[#0d0d0d]' : 'border-white/15 text-white/40 hover:border-[#c8b89a]/50 hover:text-[#c8b89a]' }}"
                    >
                        All Products
                    </a>
                    ...
                    @foreach($categories as $category)
                        <a
                            href="{{ route('products.catalog', ['category' => $category]) }}"
                            class="border px-4 py-2 text-[9px] uppercase tracking-[0.18em] transition
                                {{ $activeCategory === $category ? 'border-[#c8b89a] bg-[#c8b89a] text-[#0d0d0d]' : 'border-white/15 text-white/40 hover:border-[#c8b89a]/50 hover:text-[#c8b89a]' }}"
                        >
                            {{ $category }}
                        </a>
                    @endforeach
                    ...
                    @forelse($products as $product)
                        ...
                        <div class="group relative flex flex-col bg-[#1a1a1a] transition duration-300 hover:bg-[#222]">
                            ...
                            <div class="relative aspect-[4/3] w-full overflow-hidden bg-[#222]">
                                ...
                                {{-- Icon badge overlaid in the corner of the image --}}
                                ...
                                {{-- Product number watermark, kept subtle over the photo --}}
                ...
                <div class="mt-12">
                    ...
                    >
                        <span>Request Full Product List</span>
