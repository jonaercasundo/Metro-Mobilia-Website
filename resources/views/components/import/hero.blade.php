...
>
    ...
    <div class="relative z-20 mx-auto max-w-4xl px-6 py-32">
        ...
        <p class="mx-auto mt-6 max-w-xl text-sm font-light leading-[1.9] text-white/55 sm:text-[15px]">
            Metro Mobilia Corporation is a licensed Philippine trading company Over a decade of trusted supply to the Department of Education — delivering the materials that classrooms across the nation depend on.
        </p>
