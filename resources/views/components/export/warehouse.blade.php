        ...
        <section id="warehouse" class="bg-[#ede9e1] px-6 py-20 lg:px-12 lg:py-28">
            ...
            <div class="mx-auto max-w-7xl">
                ...
                <div class="mt-14 grid items-stretch gap-3 lg:grid-cols-[1.15fr_0.85fr]">
                    ...
                    {{-- IMAGE --}}
                    <div class="group relative min-h-[460px] overflow-hidden bg-[#222]">
                        ...
                        <div class="absolute left-7 top-7 border border-white/20 bg-black/20 px-3 py-2 backdrop-blur-sm">
                            <span class="text-[9px] uppercase tracking-[0.18em] text-white/60">
                                Operations
                            </span>
                        </div>
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-7 lg:p-9">
                            ...
                            <p class="max-w-lg font-serif text-lg font-light italic leading-[1.6] text-white/75">
                                Reliable logistics, organized inventory, and coordinated
                                delivery supporting projects across the Philippines.
                            </p>
